    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="images/eyakub.png" style="width:100%">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>eyakubsorkar@mail.com</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>01937424217</p>
          <hr>
          ...
          <div class="w3-light-grey w3-round-xlarge">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="height:24px;width:60%">60%</div>
          </div>
          <br>
        </div>
      </div><br>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <p>Studying B.Sc In C.S.E At Daffodin International University.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Web Developer </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Current</h6>
          <p></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Android Developing</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Current</h6>
          <p>Just Learning a little on Android Developing </p><br>
        </div>
      </div>
...
<footer class="w3-container w3-teal w3-center w3-margin-top">
  ...
  <p>Powered by <a href="www.facebook.com/mdes.mdes" target="_blank">Eyakub</a></p>
</footer>
